...
from source.pymodules import tabulate_conf_matr, print_loss_list, get_best_val_epochs, tabulate_5cv_results
# train_utils
...
if __name__ == "__main__":
    ...
    pickle_runs_dict = {
        'clahe': {
            'rp': '/path/to/run/path/for/stage2',
            'I2CVB': 'test-2021-10-04_13-43-35.pickle',
            'UDE': 'test-2021-10-04_19-21-35.pickle',
            'combined': 'test-2021-10-05_07-22-47.pickle'
        }
    }
    ...
    include_classes = [1, 2] # pz, cg, 0 is bg
